...
const Header = ({
  ...
  return (
    <header className="top-0 left-0 w-full z-50 bg-white shadow-md px-6 py-4 flex justify-between items-center">
        ...
        {isLogedin && (
          <div className="flex gap-2 items-center">
            <input
              ...
              className="border px-3 py-1 text-sm rounded border-orange-400"
              value={workflowName}
            ...
            <input
              ...
              disabled={loading}
            />
            <button onClick={onRun} disabled={loading} className="px-4 py-2 text-orange-600 border border-orange-500 rounded hover:bg-orange-100 transition">
              Run
            </button>
            <button onClick={onSave} disabled={loading} className="px-4 py-2 text-orange-600 border border-orange-500 rounded hover:bg-orange-100 transition">
              Save Project
            </button>
            <button onClick={onNew} disabled={loading} className="px-4 py-2 text-white bg-orange-500 rounded hover:bg-orange-600 transition">
              New Project
            </button>
          </div>
        )}
